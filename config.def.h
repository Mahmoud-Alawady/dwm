...
static const char col_gray4[] = "#050505";
...
static const Rule rules[] = {
    ...
    {"obs",             NULL, NULL,         1 << 6,             0, 0, -1},
    {"firefox",         NULL, NULL,         1 << 8,             0, 0, -1},
    {"VSCodium",        NULL, NULL,         1 << 1 | 1 << 2,    0, 0, -1},
    {"Codium",          NULL, "Open Folder",0,                  1, 1, -1},
    {"scrcpy",          NULL, NULL,         1 << 1,             0, 0, -1},
    {"emulator",        NULL, NULL,         1 << 1,             0, 0, -1},
    {"Alacritty",       NULL, "MyScratch",  0,                  1, 1, -1},
    // {"mpv",             NULL, NULL,         1 << 7,             0, 0, -1},
    // {"Sxiv",            NULL, NULL,         1 << 7,             0, 0, -1},
...
static const Key keys[] = {
    ...
    TAGKEYS(XK_1, 0) TAGKEYS(XK_2, 1) TAGKEYS(XK_3, 2) TAGKEYS(XK_4, 3)
        TAGKEYS(XK_5, 4) TAGKEYS(XK_6, 5) TAGKEYS(XK_7, 6) TAGKEYS(XK_8, 7)
            TAGKEYS(XK_9, 8){MODKEY | Mod1Mask, XK_Delete, quit, {0}},
};
